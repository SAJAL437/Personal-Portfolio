    ...
    <section className="relative w-full min-h-[80vh] flex flex-col-reverse lg:flex-row items-center justify-between gap-6 pt-12 lg:pt-4 pb-4 overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 opacity-15 select-none pointer-events-none font-mono text-[11px] text-slate-600 leading-relaxed z-0 hidden lg:block">
        <div className="absolute top-6 left-2 bg-[#060d1a]/60 p-3 rounded-xl border border-white/[0.03] backdrop-blur-md shadow-xl">
          ...
          <br />
          &nbsp;&nbsp;verification: <span className="text-emerald-400">true</span>
          <br />
          &#125;);
        </div>

        <div className="absolute bottom-8 left-6 border-l border-teal-500/20 pl-4">
          <span className="text-slate-500">// NIMCET Logical Reasoning Core</span>
          <br />
          <span className="text-teal-400">Vector_Space</span> = [A<sub>T</sub> &times; B<sub>T</sub>] &rarr; Det(&Delta;) &ne; 0
        </div>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-2 border-t border-b border-white/[0.04] py-3 mb-6 bg-[#040912]/10 rounded-xl px-2 sm:px-4">
          <div className="min-w-0">
            <p className="text-[8px] sm:text-[10px] font-mono text-slate-500 uppercase tracking-wider truncate">Database Engine</p>
            <p className="text-[9px] sm:text-sm font-semibold text-emerald-400 mt-0.5 font-mono truncate">POSTGRES</p>
          </div>
          <div className="border-l border-white/[0.04] pl-2 min-w-0">
            <p className="text-[8px] sm:text-[10px] font-mono text-slate-500 uppercase tracking-wider truncate">Architecture</p>
            <p className="text-[9px] sm:text-sm font-semibold text-teal-400 mt-0.5 font-mono truncate">REST / MVC</p>
          </div>
          <div className="border-l border-white/[0.04] pl-2 min-w-0">
            <p className="text-[8px] sm:text-[10px] font-mono text-slate-500 uppercase tracking-wider truncate">Vitals State</p>
            <p className="text-[9px] sm:text-sm font-semibold text-indigo-400 mt-0.5 font-mono truncate">9ms LATENCY</p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 relative w-full">
          ...
          >
            ...
            <span className="hidden sm:inline-block font-mono text-[9px] text-indigo-400">&larr;&rarr;</span>
          </a>
        </div>
      </motion.div>
      ...
      <div className="w-full lg:w-[48%] flex justify-center items-center relative z-10 max-h-[550px]">
        ...
        <div className="absolute bottom-2 left-2 bg-[#040914]/95 border border-white/[0.03] py-1.5 px-2.5 rounded-lg shadow-xl z-20">
          <p className="text-[7px] font-mono text-slate-500 uppercase tracking-widest">Architect</p>
          <p className="text-[9px] text-slate-300 font-bold font-mono tracking-wider">SAJAL_TIWARI</p>
        </div>
