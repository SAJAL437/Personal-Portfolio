export const BIO = [
  ...
  "During his studies, he was introduced to the world of web development and major programming languages such as Java, Python, and C. He focused on Java and its Spring Boot framework to tackle real-world problems, creating several projects that integrate backend solutions with modern frontend technologies. A selection of these projects can be found on his GitHub profile and portfolio.",

  "As a multi-disciplinary developer, Sajal brings a wealth of skills and expertise to his work. His deep understanding of HTML, CSS, and JavaScript, combined with proficiency in modern libraries like React,TailwindCSS etc empowers him to craft engaging and memorable web experiences for clients and audiences alike.",
];
